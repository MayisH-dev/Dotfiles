...
-- Alt_Shift layout switcher workaround
-- awful.util.spawn("setxkbmap -layout us,am -variant ,phonetic -option grp:alt_shift_toggle")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control", "Shift"}, "l", lockscreen,
	      {description="lock the current session", group="awesome"}),
    awful.key({ modkey,           }, "j",
        function ()
            awful.client.focus.byidx( 1)
        end,
